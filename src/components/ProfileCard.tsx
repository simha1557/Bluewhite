...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  // Set mounted state
  useEffect(() => {
    console.log('ProfileCard: Component mounting...');
    setIsMounted(true);
    return () => {
      console.log('ProfileCard: Component unmounting...');
      setIsMounted(false);
    };
  }, []);
  ...
  const handleContactClick = useCallback(() => {
    try {
      ...
      if (onContactClick) {
        ...
        // Default behavior - redirect to Linktree
          ...
          <div className="pc-content pc-avatar-content">
            <img
              ...
              onError={(e) => {
                ...
                // Try fallback to JPEG if PNG fails
                if (avatarUrl.includes('.png')) {
                  const fallbackUrl = avatarUrl.replace('.png', '.jpeg');
                  ...
                  <div className="pc-mini-avatar">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        const currentSrc = miniAvatarUrl || avatarUrl;
                        console.warn(`Failed to load mini avatar image: ${currentSrc}`);
                        // Try fallback to JPEG if PNG fails
                        if (currentSrc.includes('.png')) {
                          const fallbackUrl = currentSrc.replace('.png', '.jpeg');
                          console.log(`Trying fallback mini avatar: ${fallbackUrl}`);
                          target.src = fallbackUrl;
                      ...
                      onLoad={() => {
                        console.log(`Mini avatar image loaded successfully: ${miniAvatarUrl || avatarUrl}`);
                      }}
                    />
                  </div>
